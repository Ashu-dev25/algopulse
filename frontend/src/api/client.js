...
export const setAuthToken = (token) => localStorage.setItem('algopulse_token', token);
...
export const problemsApi = {
  ...
  create: (data) => apiRequest('/problems', { method: 'POST', body: JSON.stringify(data) }),
  ...
  update: (id, data) => apiRequest(`/problems/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
...
export const validatorApi = {
  ...
  validateUrl: (url, platform) => apiRequest('/validate/submission-url', {
    method: 'POST',
